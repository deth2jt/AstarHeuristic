...
public class JeromeThompsonDubinCarController implements CarController {
	...
	public void move()  {
		...
		*/
		...
		double angleDelTa = .14;
		double distanceDelTa = 5.0;
		boolean stay = true;
	...
	boolean isValid (CarState c)
    {
        ...
        */
            ...
            carSim.init (c.x+this.lenOfCar/2, c.y+this.lenOfCar/2, c.angle, this.obstacles);
